...
@EC, we do not surrender any usage data which belong to our subscribers to any authoritative business/entities and instead, EC provides a set of software utilities (e.g. distributed/embedded dataset) to collect the activity of data usage (optional) in order to help our subscribers to understand their usage model, even to market/produtise such model.
### Zero-Trust Security
