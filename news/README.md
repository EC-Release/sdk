...
@EC, we do not expose any usage data owned by the subscribers to any authoritative business/entities and instead, EC provides a set of software utilities (e.g. distributed/embedded dataset) to collect the activity of data usage (optional) to help our subscribers better understand the usage for any market/produtise purposes.
### Zero-Trust Security
